...
export const CUSTOMER_NAV_ITEMS = [
  ...
  { id: 'refer', label: 'Customer Referral', icon: 'Gift', tab: 'refer' },
...
export const AGENT_NAV_ITEMS = [
  ...
  { id: 'refer', label: 'Agent Referral', icon: 'Gift', view: 'refer' },
  { id: 'customer-referral', label: 'Customer Referral', icon: 'Share2', view: 'customer-referral' },
...
export const EMPLOYEE_NAV_ITEMS = [
  ...
  { id: 'agent-referral', label: 'Agent Referral', icon: 'UserPlus', tab: 'agent-referral' },
  { id: 'customer-referral', label: 'Customer Referral', icon: 'Gift', tab: 'customer-referral' },
  { id: 'support', label: 'Support Center', icon: 'Headphones', tab: 'support' },
  { id: 'settings', label: 'Settings', icon: 'Settings', tab: 'settings' },
];

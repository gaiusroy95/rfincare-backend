...
export const ADMIN_NAV_ITEMS = [
  ...
  { label: 'Post office', tab: 'post-office', icon: 'Mailbox' },
  { label: 'Government schemes', tab: 'government-schemes', icon: 'Landmark' },
  { label: 'Investment products', tab: 'investment-products', icon: 'Gem' },

 ...
 * Set showSiteHeader to render the main marketing Header above the shell.
 */
const PortalShell = ({
  ...
  return (
    <>
      {showSiteHeader ? <Header /> : null}
      <div className={`rf-portal min-h-screen bg-[#f4f6f8]${showSiteHeader ? ' rf-portal-with-site-header' : ''}`}>
          ...
          <header className="rf-portal-topbar">
            ...
            <div className="rf-portal-topbar-toolbar">
              ...
              <div className="rf-portal-topbar-utilities">
                ...
                {!showSiteHeader ? <LanguageSwitcher /> : null}
